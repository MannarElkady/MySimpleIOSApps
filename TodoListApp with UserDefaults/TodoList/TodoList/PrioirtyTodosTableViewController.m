//
//  PrioirtyTodosTableViewController.m
//  TodoList
//
...
#import "PrioirtyTodosTableViewController.h"

@interface PrioirtyTodosTableViewController ()

@end

@implementation PrioirtyTodosTableViewController
...
- (void)viewWillAppear:(BOOL)animated{
  //  printf("Inside view Will Appear");
    ...
    NSSortDescriptor *dateDescriptor = [NSSortDescriptor sortDescriptorWithKey:@"todoPriority" ascending:NO];
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section{
    NSString* secTitle=@"All TODOs - Most Priority Todos";
    return secTitle;
}
